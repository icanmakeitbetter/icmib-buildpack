...
private
  ...
  def run_assets_precompile_rake_task
    log("assets_precompile") do
      ...
      if rake_task_defined?("assets:precompile:primary")
        ...
        if File.exists?("public/assets/manifest.yml")
          ...
          puts "Running: rake assets:precompile:primary"
          require 'benchmark'
          time = Benchmark.realtime { pipe("env PATH=$PATH:bin bundle exec rake assets:precompile:primary 2>&1") }
